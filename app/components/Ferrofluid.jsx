...
export default function Ferrofluid({
  ...
  useEffect(()=>{
    ...
    return ()=>{
      ...
      const callIfFn=(obj,key)=>{const fn=obj&&obj[key]; if(typeof fn==='function') fn.call(obj);};
  ...
  return <div ref={containerRef} className={`w-full h-full overflow-hidden relative ${className??''}`} style={{...(mixBlendMode&&{mixBlendMode})}} />;
}
